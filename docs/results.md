...
- The final evaluation at step 8,000,000 used a different number of evaluation batches than the intermediate curve points, which explains minor differences between the curve and the final number.
